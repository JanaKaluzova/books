...
export const BookCard2: FC<BookCardProps> = ({ book }) => {
	return (
		<div className="group cursor-pointer rounded-2xl bg-white p-2 shadow-card transition-all duration-300 hover:shadow-card-hover hover:-translate-y-2">
